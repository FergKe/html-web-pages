...
const change = () => {
    ...
    dots[testimonialsCount].classList.add("text-cla-light-grey");

    if ( testimonialsCount === 0 ) {
        dots[4].classList.remove("text-cla-light-grey")
    } else {
        dots[testimonialsCount - 1].classList.remove("text-cla-light-grey")
    }
}
...
const previousTestimonial = () => {
    ...
    if ( testimonialsCount === 4 ) {
        dots[0].classList.remove("text-cla-light-grey")
    } else {
        dots[testimonialsCount + 1].classList.remove("text-cla-light-grey")
    }
